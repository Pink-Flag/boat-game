...
function moveObject(obj, speed, angle = obj.angle) {
  obj.velocity.x += Math.sin(angle) * speed;
  obj.velocity.y += Math.cos(angle) * speed;
}
// function attractObject(obj, speed, attract ){
